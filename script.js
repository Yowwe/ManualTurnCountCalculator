document.addEventListener('DOMContentLoaded', function () {
    ...
    if (isNaN(endQuadrant) || endQuadrant < 1 || endQuadrant > 4) {
        ...
        return;
                ...
                // Check if start quadrant is the same as end quadrant and end angle is greater than start angle
                if (startQuadrant === endQuadrant && endAngle > startAngle) {
                ...
                if (startQuadrant === endQuadrant && startAngle + endAngle > 90) {
                    alert("Error: Start angle + end angle should be 90 for the same quadrant.");
                    return; // Exit the function to prevent further calculations
                }
